...
Hibernate 6 @SoftDelete: We used the latest Hibernate feature to handle this automatically. 
When you try to get quotes, the system is smart enough to only show you the ones that haven't been deleted yet.
